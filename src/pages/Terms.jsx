  ...
  return (
    <div className="static-page static-legal">
      ...
      <div className="legal-body">
        <section><h2>1. Acceptance</h2><p>By using Lumina Cinema, you agree to these terms. If you do not agree, please do not use our platform.</p></section>
        ...
        <section><h2>5. Intellectual Property</h2><p>All content uploaded by authors remains their property. By uploading, you grant Lumina Cinema a license to display and stream your content on our platform.</p></section>
